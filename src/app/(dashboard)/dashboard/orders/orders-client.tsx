      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="bg-background border border-border/50">
          <CardContent className="p-6">
            ...
            <div className="text-2xl font-mono font-bold">${data.stats.totalRevenue.toLocaleString()}</div>
        ...
        <Card className="bg-background border border-border/50">
          <CardContent className="p-6">
            ...
            <div className="text-2xl font-mono font-bold">${data.stats.avgOrderValue}</div>
            ...
            {data.topProducts.map((product, index) => (
              <div key={product.name} className="flex items-center justify-between p-3 border border-border/50 hover:border-border transition-all">
                ...
                <div className="text-right space-y-1">
                  <div className="text-sm font-mono font-bold">${product.revenue.toLocaleString()}</div>
                  <div className="text-xs font-mono text-muted-foreground">Avg: ${product.avgValue}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-3">
            {data.recentOrders.map((order) => (
              <div key={order.id} className="flex items-center justify-between p-3 border border-border/50 hover:border-border transition-all">
                ...
                <div className="flex items-center gap-3">
                  <div className="text-right space-y-1">
                    <div className="text-sm font-mono font-bold">${order.amount}</div>
